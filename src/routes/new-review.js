...
const NewReview = () => {
    ...
    const newReview = async (rating, title, text) => {
        ...
        const res = await fetch('https://hungry-backend-api.herokuapp.com/main/reviews/', 
        {
            method: 'POST',
            headers: {
    ...
    return (
      <div>
          ...
          <main className="login-main">
            ...
            <NewReviewForm onSubmitReview={newReview}/>
          </main>
      </div>
    )
  }
